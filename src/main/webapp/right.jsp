        ...
        <div id="managerGiftLogResourceDiv">
            ...
            <div id="managerbox">
                <form id="queryDataFrom">
                    <table>
                        <thead>
                        <tr><td colspan="6">请按要求输入条件进行查询(<font size="1px" color="red">部分框限填数字</font>)</td></tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>礼品订单号:</td><td><input type="text" name="glid" value="" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td>
                            <td>会员&emsp;编号:</td><td><input name="mid" value="" type="text"/></td>
                            <td>会员姓名:</td><td><input name="mname" value="" type="text"/></td>
                        </tr>
                        <tr>
                            <td>门店&emsp;编号:</td><td><input name="rid" value="" type="text"/></td>
                            <td>门店&emsp;名称:</td><td><input name="retailname" value="" type="text"/></td>
                            <td>门店电话:</td><td><input  name="retailmobile" value="" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td>
                        </tr>
                        <tr>
                            <td>代理商编号:</td><td><input name="aid" value="" type="text"/></td>
                            <td>代理商名称:</td><td><input name="agentname" value="" type="text"/></td>
                            <td>订单批次:</td><td><input name="servicecheckid" value="" type="text"/></td>
                        </tr>
                        </tbody>
                    </table>
                </form>
        ...
        <div id="seeGiftLogResourceDiv">
            ...
            <div class="giftMsgTab">
                <table class="GiftLogDataShow">
                    <thead>
                        <td width="13%" id="GLID">订单编号</td>
                        <td width="6%" id="MID">会员编号</td>
                        <td width="5%" id="MName">会员名称</td>
                        <td width="6%" id="MMobile">联系电话</td>
